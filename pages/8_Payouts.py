                ...
                with st.form("generate_single_payout_form"):
                    ...
                    if submitted:
                        try:
                            ...
                            # ✅ INSERT with EXACT database column names from your JSON
...
# ==============================================================================
# TAB 3: PAYOUT HISTORY & RECONCILIATION (✅ FIXED UI MAPPING)
# ==============================================================================
with tab_history:
    ...
    if not payouts_data:
        ...
        # ✅ FIX: Correctly parse cycle_start_date and cycle_end_date
        ...
        # Map transaction_ref to UTR for display
